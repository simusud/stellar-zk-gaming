...
import { ZkGameTheoryGame } from './games/zk-game-theory/ZkGameTheoryGame';

const GAME_ID = 'zk-game-theory';
const GAME_TITLE = import.meta.env.VITE_GAME_TITLE || 'Double Cross';
const GAME_TAGLINE = import.meta.env.VITE_GAME_TAGLINE || 'The Ultimate Game Theory';
      ...
      {!hasContract ? (
        <div className="card">
          ...
          <p style={{ color: 'var(--color-ink-muted)', marginTop: '1rem' }}>
            ...
            <code>VITE_ZK_GAME_THEORY_CONTRACT_ID</code> in the root <code>.env</code>.
          </p>
        </div>
      ) : !devReady ? (
        <div className="card">
